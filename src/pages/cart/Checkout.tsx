...
const Checkout = () => {
  const { shippingAddress, cartItems } = useContext(Store);
  const { user } = useAuth0();
            ...
            <div className='flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 '>
              ...
              <div className='flex justify-between xl:h-full  items-stretch w-full flex-col mt-6 md:mt-0'>
                ...
                <div className='flex w-full justify-center items-center md:justify-start md:items-start'>
                  <button className='mt-6 md:mt-0 py-5 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base leading-4 text-gray-100 bg-slate-900'>
                    PlaceOrder
                  </button>
                </div>
              </div>
